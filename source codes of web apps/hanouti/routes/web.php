...
Route::namespace('Front')->group(function () {
    ...
    Route::group(['middleware' => ['auth', 'web']], function () {
        ...
        Route::get('returnpgwpfe3ds', 'CheckoutController@returnPgwPfe3ds')->name('returnpgwpfe3ds');
        Route::post('checkout/execute', 'CheckoutController@charge')->name('checkout.execute');
        Route::get('checkout/cancel', 'CheckoutController@cancel')->name('checkout.cancel');
        Route::get('checkout/success', 'CheckoutController@success')->name('checkout.success');
        Route::get('checkout/successtest', 'CheckoutController@successtest');
        Route::resource('customer.address', 'CustomerAddressController');

        // Route::get('pgw-pfe3ds', 'HomeController@pgw_pfe3ds')->name('pgw-pfe3ds');
